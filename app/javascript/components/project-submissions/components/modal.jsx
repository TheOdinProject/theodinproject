...
const modalBodySyle = 'h-auto p-10 rounded-xl bg-white dark:bg-slate-800 w-11/12 sm:w-4/5 md:w-3/5 lg:w-2/5';
const modalCloseBtn = `
  absolute inline
  top-4 right-4 m-0 p-0 border-0
  bg-transparent
  text-slate-500 hover:text-slate-700 text-xl dark:text-slate-400 dark:hover:text-slate-200
  cursor-pointer
`;
