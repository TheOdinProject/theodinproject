...
const submissionItemClassnames = `
  relative py-6
  border-solid border-t border-slate-300
    ...
    <div className={submissionItemClassnames} ref={ref} data-test-id="submission-item">
      ...
      <div className="flex flex-col md:flex-row md:items-center">
        ...
        {isCurrentUsersSubmission
          ? (
            <div
              className="submissions-flag text-slate-300 hover:text-slate-500 dark:text-slate-400 dark:hover:text-slate-300 cursor-pointer"
          ...
          : (
            <button
              className="submissions-flag text-slate-300 hover:text-slate-500 dark:text-slate-400 dark:hover:text-slate-300 hint--top"
