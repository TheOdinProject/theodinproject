  ...
  describe 'GET #new' do
    context 'when two factor authentication is already enabled' do
      it 'redirects to the dashboard' do
        ...
        get new_admin_v2_two_factor_authentication_path

        expect(response).to redirect_to(admin_v2_dashboard_path)
      end
    end
  ...
  describe 'POST #create' do
    context 'when the otp code is valid' do
      it 'enables two factor authentication for the admin' do
        ...
        expect do
          post admin_v2_two_factor_authentication_path, params: {
