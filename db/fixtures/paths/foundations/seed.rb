...
course.add_section do |section|
  ...
  section.add_lessons(
    foundation_lessons_git.fetch('why Version Control'),
    foundation_lessons_git.fetch('Getting Started'),
    foundation_lessons_git.fetch('git reset merge'),
    foundation_lessons_git.fetch('How git Store Objects'),
    foundation_lessons_git.fetch('git branching'),
    foundation_lessons_git.fetch('Colloboration using git'),
    foundation_lessons_git.fetch('Checkout Internals'),
    foundation_lessons_git.fetch('git Limitation'),
  )
end

# (Other sections like HTML, Flexbox, JavaScript Basics, etc. remain unchanged)
# Add them below this if you want to extend further.
