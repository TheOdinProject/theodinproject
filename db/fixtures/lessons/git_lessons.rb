def git_lessons
  {
    'Introduction to Git' => build_lesson({
    ...
    'A Deeper Look at Git' => build_lesson({
    ...
    'Using Git in the Real World' => build_lesson({
