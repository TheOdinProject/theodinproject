def python_lessons
    {
      'How this Course Will Work' => {
        ...
        is_project: false,
        url: '/python_programming/introduction/how_this_course_will_work.md',
        identifier_uuid: '3645e7c7-2845-4d85-9e8a-b83294f6cb68',
      },
      'Installing Python' => {
        title: 'Installing Python',
        description: "Let's get started with installing Python!",
        is_project: false,
        url: '/python_programming/introduction/installing_python.md',
        identifier_uuid: '99b7fe68-6673-4b51-9bea-4c1c0aad59d9',
      },
      'Basic Data Types' => {
        title: 'Basic Data Types',
        description: 'In this lesson we will explore the basic data types at your disposal in Python.',
        is_project: false,
        url: '/python_programming/basic_python/basic_data_types.md',
        identifier_uuid: '3cf9a92e-6781-4112-9e8e-d3135819806b',
      },
      'Variables' => {
        title: 'Variables',
        description: 'In this lesson we will explore how to use Variables in Python.',
        is_project: false,
        url: '/python_programming/basic_python/variables.md',
        identifier_uuid: 'ca5132cc-fa76-4d66-bd12-5995739318c3',
      },
      'Input and Output' => {
        title: 'Input and Output',
        description: 'In this lesson we will explore how to input and output data in your Python programs.',
        is_project: false,
        url: '/python_programming/basic_python/input_and_output.md',
        identifier_uuid: '06fbb445-8756-4906-ae42-86f261d45f22',
      },
      'Conditional Logic' => {
        title: 'Conditional Logic',
        description: 'In this lesson we will explore how to make decisions in Python so your programs can take different paths.',
        is_project: false,
        url: '/python_programming/basic_python/conditional_logic.md',
        identifier_uuid: '1804825f-4b45-4989-93bd-8303bd75d222',
      },
      'Loops' => {
        title: 'Loops',
        description: "In this lesson we will explore how to utilize loops in Python so you don't have to repeat yourself quite as much.",
        is_project: false,
        url: '/python_programming/basic_python/loops.md',
        identifier_uuid: 'cf049293-79c3-4b92-b2bd-f038d8e4fe65',
      },
      'Lists' => {
        title: 'Lists',
        description: 'In this lesson we will explore how to use lists in Python and start using lists of data.',
        is_project: false,
        url: '/python_programming/basic_python/lists.md',
        identifier_uuid: '1a994fe7-6806-4e23-a902-8d64dcf6e9c9',
      },
      'Dictionaries' => {
        title: 'Dictionaries',
        description: 'In this lesson we will explore how to use dictionaries in Python and start using key, value pairs of data.',
        is_project: false,
        url: '/python_programming/basic_python/dictionaries.md',
      ...
      'Methods' => {
        ...
        is_project: false,
        url: '/python_programming/basic_python/methods.md',
        identifier_uuid: '0fb26819-dee9-463b-85a9-b6d5765244f8',
      },
      'Basic Enumerable Methods' => {
        title: 'Basic Enumerable Methods',
        description: 'In this lesson we will explore Pythons secret weapon, its enumerable methods.',
        is_project: false,
        url: '/python_programming/basic_python/basic_enumerable_methods.md',
      ...
      'Predicate Enumerable Methods' => {
        ...
        is_project: false,
        url: '/python_programming/basic_python/predicate_enumerable_methods.md',
      ...
      'Debugging' => {
        ...
        is_project: false,
        url: '/python_programming/basic_python/debugging.md',
      ...
      'Caesar Cipher' => {
        ...
        is_project: true,
        url: '/python_programming/basic_python_projects/caesar_cipher.md',
      ...
      'Sub Strings' => {
        ...
        is_project: true,
        url: '/python_programming/basic_python_projects/sub_strings.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Stock Picker' => {
        ...
        is_project: true,
        url: '/python_programming/basic_python_projects/stock_picker.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Bubble Sort' => {
        ...
        is_project: true,
        url: '/python_programming/basic_python_projects/bubble_sort.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Object Oriented Programming' => {
        ...
        is_project: false,
        url: '/python_programming/object_oriented_programming_basics/lesson_oop.md',
      ...
      'Tic Tac Toe' => {
        ...
        is_project: true,
        url: '/python_programming/object_oriented_programming_basics/project_tic_tac_toe.md',
        accepts_submission: true,
      ...
      'Mastermind' => {
        ...
        is_project: true,
        url: '/python_programming/object_oriented_programming_basics/project_mastermind.md',
        accepts_submission: true,
        has_live_preview: true,
      ...
      'Files and Serialization' => {
        ...
        is_project: false,
        url: '/python_programming/files_and_serialization/lesson_serialization.md',
      ...
      'Event Manager' => {
        ...
        is_project: true,
        url: '/python_programming/files_and_serialization/project_event_manager.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Hangman' => {
        ...
        is_project: true,
        url: '/python_programming/files_and_serialization/project_file_io.md',
        accepts_submission: true,
        has_live_preview: true,
      ...
      'Comprehensions' => {
        ...
        description: 'Dive into how Python uses a nifty tool called comprehensions to simplify your code.',
        is_project: false,
        url: '/python_programming/advanced_python/comprehensions.md',
        identifier_uuid: '357b39e4-d7ad-4a97-97aa-6cfccb6a6574',
      },
      'Generators' => {
        title: 'Generators',
        description: 'Discover how Python has introduced generators... todo',
        is_project: false,
        url: '/python_programming/advanced_python/generators.md',
      ...
      'A Very Brief Intro to CS' => {
        ...
        is_project: false,
        url: '/python_programming/computer_science/lesson_a_very_brief_intro_to_cs.md',
      ...
      'Recursive Methods' => {
        ...
        is_project: false,
        url: '/python_programming/computer_science/lesson_recursion.md',
      ...
      'Recursion' => {
        ...
        is_project: true,
        url: '/python_programming/computer_science/project_recursion.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Common Data Structures and Algorithms' => {
        ...
        is_project: false,
        url: '/python_programming/computer_science/lesson_common_data_structures_algorithms.md',
      ...
      'Linked Lists' => {
        ...
        is_project: true,
        url: '/python_programming/computer_science/project_linked_lists.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Binary Search Trees' => {
        ...
        is_project: true,
        url: '/python_programming/computer_science/project_binary_search_trees.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Knights Travails' => {
        ...
        is_project: true,
        url: '/python_programming/computer_science/project_knights_travails.md',
        accepts_submission: true,
        has_live_preview: false,
      ...
      'Test Driven Development' => {
        ...
        is_project: false,
        url: '/python_programming/testing_with_pytest/test_driven_development.md',
        identifier_uuid: '59cf167a-d1b0-4fd9-a964-1174efb4fdf9',
      },
      'Introduction to pytest' => {
        title: 'Introduction to pytest',
        description: 'In this lesson you will learn the basics of pytest, the most popular testing framework in the Python world.',
        is_project: false,
        url: '/python_programming/testing_with_pytest/introduction_to_pytest.md',
      ...
      'Connect Four' => {
        ...
        is_project: true,
        url: '/python_programming/testing_with_pytest/project_testing_your_python_code.md',
        accepts_submission: true,
        has_live_preview: true,
      ...
      'A Deeper Look at Git' => {
        ...
        is_project: false,
        url: '/python_programming/git/lesson_a_deeper_look_at_git.md',
      ...
      'Using Git in the Real World' => {
        ...
        is_project: false,
        url: '/python_programming/git/lesson_using_git_in_the_real_world.md',
      ...
      'Python Final Project' => {
        ...
        is_project: true,
        url: '/python_programming/conclusion/project_python_final.md',
        accepts_submission: true,
        has_live_preview: true,
      ...
      'Conclusion' => {
        ...
        is_project: false,
        url: '/python_programming/conclusion/lesson_conclusion.md',
        identifier_uuid: '2f75b1ec-3b5f-4b21-9f97-acfe6578bfb1',
      },
      'Nested Collections' => {
        title: 'Nested Collections',
        description: 'In this lesson we will explore using nested lists and nested dictionaries to store more complex data',
        is_project: false,
        url: '/python_programming/basic_python/nested_collections.md',
