def html_and_css_lessons
  {
    'Introduction to Web Accessibility' => build_lesson({
    ...
    'The Web Content Accessibility Guidelines' => build_lesson({
    ...
    'Accessible Colors' => build_lesson({
    ...
    'Keyboard Navigation' => build_lesson({
    ...
    'Accessibility Auditing' => build_lesson({
    ...
    'More CSS Properties' => build_lesson({
    ...
    'Advanced Selectors' => build_lesson({
    ...
    'Custom Properties' => build_lesson({
    ...
    'Browser Compatibility' => build_lesson({
    ...
    'Frameworks and Preprocessors' => build_lesson({
    ...
    'Introduction to Grid' => build_lesson({
    ...
    'Positioning Grid Elements' => build_lesson({
    ...
    'Advanced Grid Properties' => build_lesson({
    ...
    'Using Flexbox and Grid' => build_lesson({
    ...
    'Introduction to Responsive Design' => build_lesson({
    ...
    'Natural Responsiveness' => build_lesson({
    ...
    'Responsive Images' => build_lesson({
    ...
    'Personal Portfolio' => build_lesson({
