def foundation_lessons
  {
    'How this Course Will Work' => build_lesson({
    ...
    'Introduction to Web Development' => build_lesson({
    ...
    'Motivation and Mindset' => build_lesson({
    ...
    'Join the Odin Community' => build_lesson({
    ...
    'How Does the Web Work?' => build_lesson({
    ...
    'Installation Overview' => build_lesson({
    ...
    'Command Line Basics' => build_lesson({
    ...
    'Fundamentals Part 1' => build_lesson({
    ...
    'Fundamentals Part 2' => build_lesson({
    ...
    'JavaScript Developer Tools' => build_lesson({
    ...
    'Fundamentals Part 3' => build_lesson({
    ...
    'Understanding Errors' => build_lesson({
    ...
    'Rock Paper Scissors' => build_lesson({
    ...
    'Fundamentals Part 4' => build_lesson({
    ...
    'Fundamentals Part 5' => build_lesson({
    ...
    'Introduction to the Back End' => build_lesson({
    ...
    'Introduction to Frameworks' => build_lesson({
    ...
    'Choose Your Path Forward' => build_lesson({
    ...
    'Introduction to HTML and CSS' => build_lesson({
    ...
    'Elements and Tags' => build_lesson({
    ...
    'Working with Text' => build_lesson({
    ...
    'Inspecting HTML and CSS' => build_lesson({
    ...
    'Growing and Shrinking' => build_lesson({
    ...
    'DOM Manipulation and Events' => build_lesson({
    ...
    'Revisiting Rock Paper Scissors' => build_lesson({
    ...
    'Installing Node.js' => build_lesson({
