def foundation_lessons
  {
    ...
    'Introduction to HTML and CSS' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/html_foundations/intro_to_html_css.md',
    ...
    'HTML Boilerplate' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/html_foundations/html_boilerplate.md',
    ...
    'Elements and Tags' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/html_foundations/elements_and_tags.md',
    ...
    'Working with Text' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/html_foundations/working_with_text.md',
    ...
    'Lists' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/html_foundations/lists.md',
    ...
    'Links and Images' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/html_foundations/links_and_images.md',
    ...
    'Recipes' => {
      ...
      is_project: true,
      github_path: '/foundations/html_css/html_foundations/project_recipes.md',
    ...
    'Intro to CSS' => {
      ...
      github_path: '/foundations/html_css/css_foundations/intro_to_css.md',
      identifier_uuid: '62411617-6ac6-44f9-86c8-6817203cf6ca',
    },
    'The Cascade' => {
      title: 'The Cascade',
      description: 'Use the cascade to apply styles by specificity.',
      github_path: '/foundations/html_css/css_foundations/the_cascade.md',
    ...
    'Inspecting HTML and CSS' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/css_foundations/inspecting_html_and_css.md',
    ...
    'The Box Model' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/css_foundations/the_box_model.md',
    ...
    'Block and Inline' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/css_foundations/block_and_inline.md',
    ...
    'Introduction' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/flexbox/flexbox_intro.md',
    ...
    'Growing and Shrinking' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/flexbox/flexbox_growing_and_shrinking.md',
    ...
    'Axes' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/flexbox/flexbox_axes.md',
    ...
    'Alignment' => {
      ...
      is_project: false,
      github_path: '/foundations/html_css/flexbox/flexbox_alignment.md',
    ...
    'Landing Page' => {
      ...
      is_project: true,
      github_path: '/foundations/html_css/flexbox/project_landing_page.md',
      accepts_submission: true,
      previewable: true,
