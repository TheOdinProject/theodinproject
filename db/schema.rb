...
ActiveRecord::Schema[7.0].define(version: 20_240_120_161_214) do
  ...
  create_table 'lesson_completions', id: :serial, force: :cascade do |t|
    ...
    t.index %w[lesson_id user_id], name: 'index_lesson_completions_on_lesson_id_and_user_id', unique: true
  ...
  create_table 'lessons', id: :serial, force: :cascade do |t|
    ...
    t.index %w[identifier_uuid course_id], name: 'index_lessons_on_identifier_uuid_and_course_id', unique: true
  ...
  create_table 'path_prerequisites', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[path_id prerequisite_id], name: 'index_path_prerequisites_on_path_id_and_prerequisite_id', unique: true
  ...
  create_table 'project_submissions', id: :serial, force: :cascade do |t|
    ...
    t.index %w[user_id lesson_id], name: 'index_project_submissions_on_user_id_and_lesson_id', unique: true, where: '(discarded_at IS NULL)'
  ...
  create_table 'tf_idf_table', force: :cascade do |t|
    t.string 'word', null: false
    t.float 'tf_idf', null: false
    t.bigint 'search_record_id', null: false
    t.index ['search_record_id'], name: 'index_tf_idf_table_on_search_record_id'
  end
  ...
  add_foreign_key 'tf_idf_table', 'search_records'
end
